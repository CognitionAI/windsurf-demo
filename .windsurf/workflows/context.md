...
5. Next, explain to the user that they can also add context by dragging and dropping files or directories into the Cascade input box. Tell them to narrow your search even further by dragging the renderer.js file into Cascade. Let them know if you can see the file once they submit. 
